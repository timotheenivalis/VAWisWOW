...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	\hspace{-0.5cm}
		...
		\parbox{24cm}{ \hspace{1cm} \textsc{Estimate latent genetic variation}\\
		   ...
		   \includegraphics[width=20cm, trim = 1cm 1.7cm 1cm 0cm, clip]{Rgraph/backtransformation.pdf}
		   \end{tabular}
	  ...
	  \begin{tabular}{c c c c c c c c c c c}
	   ...
	   \end{tabular}
          ...
          \begin{itemize}
           ...
           \item Effect of missing data and immigration
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
   \Endblock{($(web.east)+(2,-4.7)$)}{57}{\hspace{18cm}\color{colorone}{\textsc{Co-authors for 
emperical work:}}}{ 
