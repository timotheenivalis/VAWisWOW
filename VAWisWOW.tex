...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
	...
	\hspace{-1cm}
		...
		\parbox{24cm}{ \hspace{1cm} \textsc{How to estimate genetic variation?}\\
		   ...
		   \footnotesize Quantitative genetic \textit{\textsc{animal models}} from relatedness matrix. Estimate G-matrix for the zero-inflation and the over-dispersed Poisson. BLALLALA
		  }
		&
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
 ...
 %% the content of the block
          ...
          \node[anchor=north] (map) at ($(box.north)+(0,-3)$) {\includegraphics[width=20cm, trim=0cm 2.5cm 0cm 2.5cm, clip]{Rgraph/map.pdf}};
