...
\coordinate (aaa) at (currenty);
	...
	\blocknodew[($(currenty)+(19.6,0)$)]{77}{\textsc{The big problem:} Additive genetic variation in fitness measures evolution across all traits and all the genome}
		{
		Yet, 
		}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
 ...
 %% the content of the block
          ...
          {\bf\LARGE Understanding genetic adaptation to climatic changes: lessons from two examples};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          ...
          {\bf\LARGE Understanding the interplay between genetic evolution and population dynamics}; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%		
   \Endblock{($(web.east)+(2,-4)$)}{57}{\hspace{25cm}\color{colorone}{Co-authors:}}{ 
