...
nbs <- 100
roundnb <- 3
distrib <- data.frame(pxpx = round(density(pxp, n = nbs)$x,roundnb), pxpy = round(density(pxp, n = nbs)$y, roundnb) , pxzix = round(density(pxzi, n = nbs)$x, roundnb), pxziy = round(density(pxzi, n = nbs)$y, roundnb))
